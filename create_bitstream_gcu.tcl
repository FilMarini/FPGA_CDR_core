...
read_vhdl -library usrDefLib [glob gcu/src/hdl/*.vhd]
...
#write checkpoint
write_checkpoint -force $outputDir/post_synth_gcu.dcp

#report_timing_summary -file $outputDir/post_synth_timing_summary.rpt
#report_utilization -file $outputDir/post_synth_util.rpt

#read constraints file
source gcu/src/constraints/gcu_board_cons.tcl
...
write_checkpoint -force $outputDir/post_place_gcu.dcp
#report_utilization -file $outputDir/post_place_util.rpt
#report_timing_summary -file $outputDir/post_place_timing_summary.rpt

#Route design and generate bitstream
route_design -directive Explore
write_checkpoint -force $outputDir/post_route_gcu.dcp
