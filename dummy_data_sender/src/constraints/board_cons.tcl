...
set_property PACKAGE_PIN AD21 [get_ports prbs_to_cat5_p_o]
set_property IOSTANDARD LVDS_25 [get_ports prbs_to_cat5_p_o]

set_property PACKAGE_PIN AA15 [get_ports prbs_from_cat5_p_i]
set_property IOSTANDARD LVDS [get_ports prbs_from_cat5_p_i]
